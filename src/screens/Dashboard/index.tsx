...
import { TransactionCard, TransactionCardProps, Props } from "../../components/HighlightCard/TransactionCard";
    ...
    return (
        <Container>
            <Header>
                <UserContainer>
                    <UserInfo>
                        <Photo source={{ uri: 'https://avatars.githubusercontent.com/u/103393497?v=4' }} />
